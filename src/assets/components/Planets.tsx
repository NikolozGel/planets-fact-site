  ...
  return (
    <div>
      ...
      <div className="md:flex items-center justify-center">
        <div className="flex flex-col items-center mb-[32px] md:mr-[69px]">
        ...
        <div className="hidden md:block">
          <div className="w-[281px] h-[40px] border flex items-center mb-4 md:hover:bg-[#EDA249] cursor-pointer">
          ...
          <div className="w-[281px] h-[40px] border flex items-center md:hover:bg-[#EDA249] cursor-pointer">
            <p className="text-white md:ml-[20px]">01</p>
            <p className="text-white  md:ml-[17px]">OVERVIEW</p>
          </div>
        </div>
